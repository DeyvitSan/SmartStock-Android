...
class AddProductUseCase @Inject constructor(private val repository: InventoryRepository) {
    suspend operator fun invoke(product: Product): Result<Unit> = repository.addProduct(product)
}
